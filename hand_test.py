...
with mp_hands.Hands(max_num_hands=1, min_detection_confidence=0.7) as hands:
    ...
    "Pinky": "EXTENDED" if pinky_base.y - pinky_tip.y > 0.28 else "CURLED",}
                ...
                if fingers["Index"] == "CURLED" and fingers["Middle"] == "EXTENDED" and fingers["Ring"] == "EXTENDED" and fingers["Pinky"] == "EXTENDED" and fingers["Thumb"] == "TUCKED":
                ...
                if fingers["Index"] == "CURLED" and fingers["Middle"] == "CURLED" and fingers["Ring"] == "CURLED" and fingers["Pinky"] == "CURLED" and fingers["Thumb"] == "TUCKED" and abs(thumb_tip.y - index_tip.y) > 0.1:
                    cv2.putText(frame, "MUSHTHI", (10,330), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
                if fingers["Index"] == "CURLED" and fingers["Middle"] == "CURLED" and fingers["Ring"] == "CURLED" and fingers["Pinky"] == "CURLED" and fingers["Thumb"] == "EXTENDED":
                    cv2.putText(frame, "SHIKHARA", (10,330), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
                if fingers["Index"] == "CURLED" and fingers["Middle"] == "CURLED" and fingers["Ring"] == "CURLED" and fingers["Pinky"] == "CURLED" and fingers["Thumb"] == "TUCKED" and abs(thumb_tip.y - index_tip.y) < 0.1:
                    cv2.putText(frame, "KAPITTHA", (10,330), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
                spread = abs(thumb_tip.y - index_tip.y)
                print(f"Spread: {abs(ring_tip.y - thumb_tip.y):.2f}")
